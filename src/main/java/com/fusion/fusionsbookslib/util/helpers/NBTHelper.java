package com.fusion.fusionsbookslib.util.helpers;

import com.fusion.fusionsbookslib.block.tile.AltarTileEntity;
...
public class NBTHelper {
    public static CompoundNBT toNBT(Object o){
        ...
        if (o instanceof AltarTileEntity){
            return writeAltar((AltarTileEntity)o);
        }

        return null;
    }

    private static CompoundNBT writeAltar(AltarTileEntity o){
